<?php
/**
 * Plugin Name: SpawnWP Deploy — WordPress Blueprint Capture & Site Migration
 * Plugin URI: https://spawnwp.com/docs/wordpress-development/
 * Description: Deploy and migrate WordPress sites with reusable blueprints — capture a configured site once, publish it to a fresh installation.
 * Version: 0.3.6
...
define( 'SPAWNWP_DEPLOY_VERSION', '0.3.6' );
