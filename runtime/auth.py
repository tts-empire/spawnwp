...
:root{color-scheme:dark}*{box-sizing:border-box}body{margin:0;padding:48px 0;background:#000;color:#f8f8f8;font:14px/1.5 system-ui;min-height:100vh;display:flex;justify-content:center;align-items:flex-start}.box{width:min(440px,calc(100% - 32px));border-top:2px solid #f6b269;padding:28px 0}h1{font-size:24px;margin:0 0 8px}h2{font-size:18px;margin:22px 0 6px}p{color:#a1a1aa;line-height:1.5;margin:6px 0}.step{color:#f6b269;font-size:11px;font-weight:700;text-transform:uppercase}.help{font-size:12px}.notice{border-left:2px solid #3a3a40;padding-left:12px;margin:14px 0}label{display:block;margin:14px 0 6px;font-size:11px;text-transform:uppercase;color:#a1a1aa}input,button{width:100%;min-height:44px;padding:11px;background:#151518;color:#fff;border:1px solid #3a3a40;border-radius:4px;font:inherit}input:focus-visible,button:focus-visible{outline:2px solid #f6b269;outline-offset:2px}button{margin-top:14px;background:#f6b269;color:#0d0d10;font-weight:700;cursor:pointer}button:disabled{opacity:.55;cursor:wait}.alt{background:#202024;color:#fff}.small{width:auto;min-height:38px;margin:8px 0 0;padding:8px 10px}.err{color:#ff7373;min-height:20px}.ok{color:#7bd88f}.hide{display:none}code{word-break:break-all;color:#f6b269}.secret,.codes{white-space:pre-wrap;background:#0d0d10;padding:12px;border:1px solid #2b2b30;border-radius:4px}.codes{line-height:1.7}#qr{display:block;width:220px;height:220px;margin:16px auto;background:#fff;padding:12px;border-radius:4px}@media(max-width:480px){body{padding:24px 0}}</style></head><body><main class=box><h1>Spawn<span style='color:#f6b269'>WP</span></h1><p id=intro>Secure cockpit access</p>
